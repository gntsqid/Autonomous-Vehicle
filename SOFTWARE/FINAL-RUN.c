...
int main(void)
{
    ...
    while (1) {
        ...
        switch (run_mode) {
            ...
            case 2:
                GPIO_PORTF_DATA_R = 2;
                if (down_range_dist > 2200.0 && left_dist < 50 && right_dist < 50 && left_dist!=0 && right_dist!=0) run_mode=3; // original testing is done after 900 cm = 9 meters // final fits closer to the 21 meter course length
                    break;
